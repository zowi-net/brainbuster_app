...
//   /// Submits the form by adding a new question to the selected category document.
//   void _submitForm() async {
//     String question = questionController.text.trim();
//     String option1 = option1Controller.text.trim();
//     String option2 = option2Controller.text.trim();
...
//         option4.isNotEmpty &&
//         answer.isNotEmpty) {
//       // Get a reference to the selected category document.
//       DocumentReference categoryDoc = FirebaseFirestore.instance
//           .collection('category')
...
//         child: Column(
//           children: [
//             // Dropdown to select a category document from Firestore.
//             StreamBuilder<QuerySnapshot>(
//               stream: FirebaseFirestore.instance.collection('category').snapshots(),
//               builder: (context, snapshot) {
//                 if (!snapshot.hasData) {
...
//                 List<DocumentSnapshot> docs = snapshot.data!.docs;
//                 if (docs.isEmpty) {
//                   return const Text("No categories found. Add a category first.");
//                 }
//                 List<DropdownMenuItem<String>> items = docs.map((doc) {
//                   return DropdownMenuItem<String>(
//                     value: doc.id,
